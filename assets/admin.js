const STORAGE_KEY='styleGlowProducts';
const AD_KEY='styleGlowAd';
const SESSION_KEY='styleGlowAdminSession';
const ALLOWED_EMAIL_HASHES=['24e49e35b21e68a0bbcebf3fd9d0a8f1d3b78d7f86080ac485c9f571799fea82','9d89cd255cd52eded011d91169939fc6c100f6deb91cce70a8698b32e43cb8ba'];
const PASS_HASH='38a461bb40146d190082686c27840e40b9be5c5c56f9a7f981f2cefdb6401f96';
...
function clearLoginFields(){['adminEmail','adminPassword','captchaAnswer'].forEach(id=>{const el=$('#'+id);if(el){el.value='';el.defaultValue='';el.setAttribute('autocomplete','off')}})}
function showAdmin(){ $('#loginPanel').hidden=true; $('#adminArea').hidden=false; initAdminArea(); }
